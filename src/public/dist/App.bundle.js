...
var mapOptions = {
  center: { lat: 32.75, lng: -97.34 },
  zoom: 12
};

function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 32.75;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -97.34;
